  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
          ...
          while ($linha = mysqli_fetch_array($tabela))
          {
            ...
            <tr>
              ...
              <td width=80 align="center">
                <a href="inclui_carrinho.php?acao=add&cod=<?php echo $linha['cod_produto']; ?>">
        ...
        <a class="btn btn-outline-success" href="finaliza_cart.php?endereco=sim">Ordem de venda <strong>COM</strong> endereço de cliente</a>
        <a class="btn btn-outline-success" href="finaliza_cart.php?endereco=nao">Ordem de venda <strong>SEM</strong> endereço de cliente</a>
      </div>
