    ...
    <div class="row">
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
        ...
        <table align=center border=1 width=100%>
          <tr>
            <td align=center colspan=8>SEU ESTOQUE</td>
          </tr>
          <td align="center">
            <b>COD</b>
          </td>
          ...
          <td><b>Vezes comprado</b></td>
          <td align="center" colspan="3">
            <a href="incluir.php"><b>INCLUIR</b></a>
          </td>
          <?php
          ...
          if ($row == 1) {
            ...
            while ($linha = mysqli_fetch_array($tabela))
            {
              ...
              <tr>
                ...
                <td>
                  <?php echo $linha['vezes_comprado']; ?>
                </td>


                <td width=50 align="center">
                  <a href="altera_estoque.php?acao=remove&cod=<?php echo $linha['cod_produto']; ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-x-lg" viewBox="0 0 16 16">
                      <path d="M1.293 1.293a1 1 0 0 1 1.414 0L8 6.586l5.293-5.293a1 1 0 1 1 1.414 1.414L9.414 8l5.293 5.293a1 1 0 0 1-1.414 1.414L8 9.414l-5.293 5.293a1 1 0 0 1-1.414-1.414L6.586 8 1.293 2.707a1 1 0 0 1 0-1.414z"/>
                    </svg>
                  </a>
                  <a href="altera.php?acao=altera&cod=<?php echo $linha['cod_produto']; ?>">
